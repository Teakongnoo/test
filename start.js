(() => {
  // เริ่มเขียนโค้ด
  /** This Function for get Element from
   *  HTML and get innerWidth and innerHeight */
  function setup(){
 ...
 */
  ...
  /**
   * 
   * create snowBall by get canvas and numberOfSnowBall
   */
